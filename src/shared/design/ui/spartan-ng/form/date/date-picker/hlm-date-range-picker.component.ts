...
export const HLM_DATE_RANGE_PICKER_VALUE_ACCESSOR = {
	...
	useExisting: forwardRef(() => HlmDateRangePickerComponent),
	multi: true,
};

@Component({
	selector: 'hlm-date-range-picker',
	imports: [HlmPopoverImports, HlmCalendarRangeComponent],
	providers: [
...
export class HlmDateRangePickerComponent<T> implements HlmDatePickerBase<T>, ControlValueAccessor {
