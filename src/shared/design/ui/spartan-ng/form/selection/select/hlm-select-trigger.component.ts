...
@Component({
	...
	template: `
		...
		>
			<ng-content />
			<span class="material-symbols-outlined text-muted-foreground text-[length:--spacing(4)] ms-auto">keyboard_arrow_down</span>
		</button>
	`,
})
