...
/**
 * Input de correo: `hlm-input-base` con `type="email"`.
 *
 * La validacion del formato se define con el schema del formulario padre,
 * nunca dentro de este componente.
 */
@Component({
	selector: 'hlm-input-email',
...
export class HlmInputEmailComponent implements FormValueControl<string> {
